...
# Generated by qmake (3.0) (Qt 5.0.2) on: ven. avr. 11 10:43:03 2014
# Project:  projet.pro
# Template: app
# Command: /usr/lib/i386-linux-gnu/qt5/bin/qmake -spec linux-g++ -o Makefile projet.pro
#############################################################################
...
Makefile: projet.pro /usr/share/qt5/mkspecs/linux-g++/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++ -o Makefile projet.pro
...
dist: 
	@test -d .tmp/projet1.0.0 || mkdir -p .tmp/projet1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/projet1.0.0/ && $(COPY_FILE) --parents mainwindow.h configuration.h parameters.h file.h .tmp/projet1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp configuration.cpp parameters.cpp file.cpp .tmp/projet1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/projet1.0.0/ && (cd `dirname .tmp/projet1.0.0` && $(TAR) projet1.0.0.tar projet1.0.0 && $(COMPRESS) projet1.0.0.tar) && $(MOVE) `dirname .tmp/projet1.0.0`/projet1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/projet1.0.0
